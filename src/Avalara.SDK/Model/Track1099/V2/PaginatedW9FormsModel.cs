...
/// <summary>
    ...
    public partial class PaginatedW9FormsModel : IValidatableObject
    {
        ...
        public PaginatedW9FormsModel(int recordsetCount = default(int), List<OneOfW4FormDataModelW8BeneFormDataModelW8BenFormDataModelW8ImyFormDataModelW9FormDataModel> value = default(List<OneOfW4FormDataModelW8BeneFormDataModelW8BenFormDataModelW8ImyFormDataModelW9FormDataModel>), string nextLink = default(string))
        {
        ...
        public List<OneOfW4FormDataModelW8BeneFormDataModelW8BenFormDataModelW8ImyFormDataModelW9FormDataModel> Value { get; set; }
