...
/// <summary>
    ...
    public partial class SuccessResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">Unique identifier for the new or updated entity..</param>
        /// <param name="message">Success message.</param>
        public SuccessResponse(string id = default(string), string message = default(string))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>Unique identifier for the new or updated entity.</value>
        /// <example>78f6caaa-6988-4862-bd11-e52906b31b72</example>
        ...
        /// <example>Webhook subscription created successfully</example>
