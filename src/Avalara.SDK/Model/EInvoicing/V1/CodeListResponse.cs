...
/// <summary>
    ...
    public partial class CodeListResponse : IValidatableObject
    {
        ...
        public CodeListResponse(string countryCode = default(string), string codeListId = default(string), string codeListName = default(string), string description = default(string), string standard = default(string), List<CodeListVersion> versions = default(List<CodeListVersion>))
        {
