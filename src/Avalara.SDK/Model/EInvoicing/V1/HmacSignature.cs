...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "HmacSignature")]
    public partial class HmacSignature : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HmacSignature" /> class.
        /// </summary>
        ...
        public HmacSignature(string key = default(string), AlgorithmEnum algorithm = default(AlgorithmEnum))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for HmacSignature and cannot be null");
            }
            this.Key = key;
