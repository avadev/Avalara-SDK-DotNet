...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "PaginatedQueryResultModel_Form1099Base")]
    public partial class PaginatedQueryResultModelForm1099Base : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedQueryResultModelForm1099Base" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="value">value.</param>
        /// <param name="nextLink">nextLink.</param>
        public PaginatedQueryResultModelForm1099Base(int? recordsetCount = default(int?), List<Get1099Form200Response> value = default(List<Get1099Form200Response>), string nextLink = default(string))
        {
        ...
        public List<Get1099Form200Response> Value { get; set; }
