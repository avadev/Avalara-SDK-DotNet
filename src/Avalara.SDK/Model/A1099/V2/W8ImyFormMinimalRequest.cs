...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "W8ImyFormMinimalRequest")]
    public partial class W8ImyFormMinimalRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="W8ImyFormMinimalRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected W8ImyFormMinimalRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="W8ImyFormMinimalRequest" /> class.
        /// </summary>
        ...
        public W8ImyFormMinimalRequest(string email = default(string), string name = default(string), string referenceNumber = default(string), string companyId = default(string), string referenceId = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for W8ImyFormMinimalRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for W8ImyFormMinimalRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "companyId" is required (not null)
            if (companyId == null)
            {
                throw new ArgumentNullException("companyId is a required property for W8ImyFormMinimalRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class W8ImyFormMinimalRequest {\n");
