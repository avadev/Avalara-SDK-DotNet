...
/// <summary>
    /// IrsResponse
    /// </summary>
    [DataContract(Name = "IrsResponse")]
    public partial class IrsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IrsResponse" /> class.
        /// </summary>
        /// <param name="code">The IRS response code..</param>
        /// <param name="description">The description for the IRS response..</param>
        public IrsResponse(string code = default(string), string description = default(string))
        {
            this.Code = code;
