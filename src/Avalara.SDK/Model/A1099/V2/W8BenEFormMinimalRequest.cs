...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "W8BenEFormMinimalRequest")]
    public partial class W8BenEFormMinimalRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="W8BenEFormMinimalRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected W8BenEFormMinimalRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="W8BenEFormMinimalRequest" /> class.
        /// </summary>
        ...
        public W8BenEFormMinimalRequest(string email = default(string), string name = default(string), string referenceNumber = default(string), string companyId = default(string), string referenceId = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for W8BenEFormMinimalRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for W8BenEFormMinimalRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "companyId" is required (not null)
            if (companyId == null)
            {
                throw new ArgumentNullException("companyId is a required property for W8BenEFormMinimalRequest and cannot be null");
            }
