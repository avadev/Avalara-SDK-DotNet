...
/// <summary>
    ...
    public partial class Form1099Int : IValidatableObject
    {
        ...
        /// <param name="earlyWithdrawalPenalty">earlyWithdrawalPenalty.</param>
        /// <param name="usSavingsBondsInterest">usSavingsBondsInterest.</param>
        ...
        /// <param name="foreignCountry">foreignCountry.</param>
        /// <param name="taxExemptInterest">taxExemptInterest.</param>
        /// <param name="specifiedPrivateActivityBondInterest">specifiedPrivateActivityBondInterest.</param>
        /// <param name="marketDiscount">marketDiscount.</param>
        /// <param name="bondPremium">bondPremium.</param>
        /// <param name="bondPremiumOnTreasuryObligations">bondPremiumOnTreasuryObligations.</param>
        /// <param name="bondPremiumOnTaxExemptBond">bondPremiumOnTaxExemptBond.</param>
        /// <param name="taxExemptBondCusipNumber">taxExemptBondCusipNumber.</param>
