...
/// <summary>
    ...
    public partial class Form1099Int : IValidatableObject
    {
        ...
        /// <param name="taxExemptBondCusipNumber">Tax exempt bond CUSIP no.   Enter VARIOUS if the tax-exempt interest is reported in the aggregate for multiple bonds or accounts..</param>
        ...
        /// </summary>
        /// <value>Tax exempt bond CUSIP no.   Enter VARIOUS if the tax-exempt interest is reported in the aggregate for multiple bonds or accounts.</value>
