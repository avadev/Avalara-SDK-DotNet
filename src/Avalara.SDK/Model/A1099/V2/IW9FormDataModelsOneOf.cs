...
namespace Avalara.SDK.Model.A1099.V2
{
    ...
    /// </summary>
    [JsonConverter(typeof(IW9FormDataModelsOneOfJsonConverter))]
    [DataContract(Name = "IW9FormDataModelsOneOf")]
    public partial class IW9FormDataModelsOneOf : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IW9FormDataModelsOneOf" /> class
        /// with the <see cref="W4FormDataModel" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of W4FormDataModel.</param>
        public IW9FormDataModelsOneOf(W4FormDataModel actualInstance)
        {
        ...
        public IW9FormDataModelsOneOf(W8BeneFormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public IW9FormDataModelsOneOf(W8BenFormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public IW9FormDataModelsOneOf(W8ImyFormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public IW9FormDataModelsOneOf(W9FormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IW9FormDataModelsOneOf {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, IW9FormDataModelsOneOf.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of IW9FormDataModelsOneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of IW9FormDataModelsOneOf</returns>
        public static IW9FormDataModelsOneOf FromJson(string jsonString)
        {
            IW9FormDataModelsOneOf newIW9FormDataModelsOneOf = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newIW9FormDataModelsOneOf;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W4FormDataModel>(jsonString, IW9FormDataModelsOneOf.SerializerSettings));
                }
                else
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W4FormDataModel>(jsonString, IW9FormDataModelsOneOf.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W8BenFormDataModel>(jsonString, IW9FormDataModelsOneOf.SerializerSettings));
                }
                else
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W8BenFormDataModel>(jsonString, IW9FormDataModelsOneOf.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W8BeneFormDataModel>(jsonString, IW9FormDataModelsOneOf.SerializerSettings));
                }
                else
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W8BeneFormDataModel>(jsonString, IW9FormDataModelsOneOf.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W8ImyFormDataModel>(jsonString, IW9FormDataModelsOneOf.SerializerSettings));
                }
                else
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W8ImyFormDataModel>(jsonString, IW9FormDataModelsOneOf.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W9FormDataModel>(jsonString, IW9FormDataModelsOneOf.SerializerSettings));
                }
                else
                {
                    newIW9FormDataModelsOneOf = new IW9FormDataModelsOneOf(JsonConvert.DeserializeObject<W9FormDataModel>(jsonString, IW9FormDataModelsOneOf.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for IW9FormDataModelsOneOf
    /// </summary>
    public class IW9FormDataModelsOneOfJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(IW9FormDataModelsOneOf).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return IW9FormDataModelsOneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return IW9FormDataModelsOneOf.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
