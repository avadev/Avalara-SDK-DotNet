...
/// <summary>
    /// IssuerBase
    /// </summary>
    [DataContract(Name = "IssuerBase")]
    public partial class IssuerBase : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssuerBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IssuerBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IssuerBase" /> class.
        /// </summary>
        ...
        public IssuerBase(string name = default(string), string dbaName = default(string), string tin = default(string), string referenceId = default(string), string telephone = default(string), int? taxYear = default(int?), string countryCode = default(string), string email = default(string), string address = default(string), string city = default(string), string state = default(string), string zip = default(string), string foreignProvince = default(string), string transferAgentName = default(string), bool? lastFiling = default(bool?))
        {
            ...
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for IssuerBase and cannot be null");
            }
            this.Address = address;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for IssuerBase and cannot be null");
            }
            this.City = city;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for IssuerBase and cannot be null");
            }
            this.State = state;
            // to ensure "zip" is required (not null)
            if (zip == null)
            {
                throw new ArgumentNullException("zip is a required property for IssuerBase and cannot be null");
            }
            this.Zip = zip;
            // to ensure "lastFiling" is required (not null)
            if (lastFiling == null)
            {
                throw new ArgumentNullException("lastFiling is a required property for IssuerBase and cannot be null");
            }
