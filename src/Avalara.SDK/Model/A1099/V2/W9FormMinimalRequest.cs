...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "W9FormMinimalRequest")]
    public partial class W9FormMinimalRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="W9FormMinimalRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected W9FormMinimalRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="W9FormMinimalRequest" /> class.
        /// </summary>
        ...
        public W9FormMinimalRequest(string email = default(string), string name = default(string), string accountNumber = default(string), string companyId = default(string), string referenceId = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for W9FormMinimalRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for W9FormMinimalRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "companyId" is required (not null)
            if (companyId == null)
            {
                throw new ArgumentNullException("companyId is a required property for W9FormMinimalRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class W9FormMinimalRequest {\n");
