...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "SubstantialUsOwnerRequest")]
    public partial class SubstantialUsOwnerRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubstantialUsOwnerRequest" /> class.
        /// </summary>
        ...
        public SubstantialUsOwnerRequest(string name = default(string), string address = default(string), string tin = default(string))
        {
            this.Name = name;
