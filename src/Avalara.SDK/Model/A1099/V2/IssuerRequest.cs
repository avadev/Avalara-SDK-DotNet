...
/// <summary>
    /// IssuerRequest
    /// </summary>
    [DataContract(Name = "IssuerRequest")]
    public partial class IssuerRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssuerRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IssuerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IssuerRequest" /> class.
        /// </summary>
        ...
        public IssuerRequest(string name = default(string), string dbaName = default(string), string tin = default(string), string referenceId = default(string), string telephone = default(string), int? taxYear = default(int?), string countryCode = default(string), string email = default(string), string address = default(string), string city = default(string), string state = default(string), string zip = default(string), string foreignProvince = default(string), string transferAgentName = default(string), bool? lastFiling = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for IssuerRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "telephone" is required (not null)
            if (telephone == null)
            {
                throw new ArgumentNullException("telephone is a required property for IssuerRequest and cannot be null");
            }
            this.Telephone = telephone;
            // to ensure "taxYear" is required (not null)
            if (taxYear == null)
            {
                throw new ArgumentNullException("taxYear is a required property for IssuerRequest and cannot be null");
            }
            this.TaxYear = taxYear;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for IssuerRequest and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for IssuerRequest and cannot be null");
            }
            this.Address = address;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for IssuerRequest and cannot be null");
            }
            this.City = city;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for IssuerRequest and cannot be null");
            }
            this.State = state;
            // to ensure "zip" is required (not null)
            if (zip == null)
            {
                throw new ArgumentNullException("zip is a required property for IssuerRequest and cannot be null");
            }
            this.Zip = zip;
            // to ensure "lastFiling" is required (not null)
            if (lastFiling == null)
            {
                throw new ArgumentNullException("lastFiling is a required property for IssuerRequest and cannot be null");
            }
